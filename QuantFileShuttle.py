...
path='C:/Users//COMPANN/Infiles/'

filelist = os.listdir(path)
os.chdir('/Users//COMPANN/Infiles/')
...
for file in filelist:
    ...
    # print(read_file)
    rawdata = pd.read_fwf(file, header=418, sep="\t")
    ...
    def getvectors():
        #Loops through every well and creates a vector for every channel
        #Vectors are appended to the dataframe "vectors"
...
print(getvectors())
    ...
    # vectorfile=vectors
    # vectorfile.to_csv(r'C:\Users\\COMPANN\Outfiles\vectors.txt')
    
    # def savevectors():
    #     #Save vectors as file
    #     vectorfile=getvectors()
    #     vectorfile.to_csv(r'C:\Users\\COMPANN\Outfiles')
    #     return vectorfile
